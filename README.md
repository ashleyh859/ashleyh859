...
|**[Hackathon: CUPet 🐾](https://github.com/vivianzhou1288/cupet)**| Built an iOS marketplace app for Cornell's AppDev Hack Challenge that connects pet owners with student sitters, featuring dual interfaces for posting and browsing pet sitting opportunities with dynamic filtering by pet type, activity level, and location. Won Honorable Mention for Most Creative. | **Swift, Python, iOS Development, REST API, URLSession, Role-based Authentication, Dynamic Filtering, Backend Integration** |
